//
// After tritongpu-partition-loops
//
...
module attributes {"ttg.num-warps" = 4 : i32, ttg.target = "cuda:100"} {
  tt.func public @attention_forward(%arg0: !ttg.memdesc<256x64xf16, #shared, #smem>, %arg1: !tt.tensordesc<tensor<64x64xf16, #shared>>, %arg2: !tt.tensordesc<tensor<64x64xf16, #shared>>, %arg3: f32, %arg4: i32, %arg5: !tt.ptr<f32>) {
    ...
    %45:6 = ttg.warp_specialize(%4, %8, %3, %result, %24, %21, %arg0, %35, %36, %37, %arg5, %13, %17, %12, %28, %33, %result_4, %1, %30, %31, %arg4, %arg1, %arg2)
    // [[SOFTMAX PARTITION]]
    default {
      %47:8 = scf.for %arg6 = %c0_i32 to %arg4 step %c64_i32 iter_args(%arg7 = %cst, %arg8 = %cst_1, %arg9 = %2, %arg10 = %c0_i32, %arg11 = %c0_i32, %arg12 = %c0_i32, %arg13 = %c0_i32, %arg14 = %c0_i32) -> (tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>>, tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>>, !ttg.async.token, i32, i32, i32, i32, i32)  : i32 {
        ...
        ttng.wait_barrier %50, %arg11 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2>
        %result_7, %token_8 = ttng.tmem_load %48[] {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<256x64xf32, #tmem, #ttng.tensor_memory, mutable, 2x256x64> -> tensor<256x64xf32, #blocked>
        ttng.arrive_barrier %49, 1 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2>
        ...
        %56 = "compute_row_max"(%result_7, %arg3) {loop.cluster = 0 : i32, loop.stage = 4 : i32} : (tensor<256x64xf32, #blocked>, f32) -> tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>>
        ...
        ttng.wait_barrier %64, %60 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        ttg.local_store %56, %62 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>> -> !ttg.memdesc<256xf32, #shared1, #smem, mutable, 3x256>
        ttng.arrive_barrier %63, 1 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        %65 = "sub_row_max"(%result_7, %56, %arg3) {loop.cluster = 0 : i32, loop.stage = 4 : i32} : (tensor<256x64xf32, #blocked>, tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>>, f32) -> tensor<256x64xf32, #blocked>
        %66 = math.exp2 %65 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256x64xf32, #blocked>
        %67 = arith.subf %arg8, %56 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>>
        %68 = math.exp2 %67 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>>
        ...
        %70 = arith.mulf %arg7, %68 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>>
        %71 = arith.addf %70, %69 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>>
        %72 = arith.truncf %66 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256x64xf32, #blocked> to tensor<256x64xf16, #blocked>
        ttng.wait_barrier %31, %arg12 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
        ttng.tmem_store %72, %result_4, %true {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256x64xf16, #blocked> -> !ttg.memdesc<256x64xf16, #tmem1, #ttng.tensor_memory, mutable>
        ttng.arrive_barrier %33, 1 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
    ...
    partition0(%arg6: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg7: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg8: !ttg.memdesc<3x64x64xf16, #shared, #smem, mutable>, %arg9: !ttg.memdesc<2x256x64xf32, #tmem, #ttng.tensor_memory, mutable>, %arg10: !ttg.memdesc<2xi64, #shared1, #smem, mutable>, %arg11: !ttg.memdesc<2xi64, #shared1, #smem, mutable>, %arg12: !ttg.memdesc<256x64xf16, #shared, #smem>, %arg13: !ttg.memdesc<3x256xf32, #shared1, #smem, mutable>, %arg14: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg15: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg16: !tt.ptr<f32>, %arg17: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg18: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg19: !ttg.memdesc<3x64x64xf16, #shared, #smem, mutable>, %arg20: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %arg21: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %arg22: !ttg.memdesc<256x64xf16, #tmem1, #ttng.tensor_memory, mutable>, %arg23: !ttg.memdesc<256x64xf32, #tmem, #ttng.tensor_memory, mutable, 1x256x64>, %arg24: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %arg25: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %arg26: i32, %arg27: !tt.tensordesc<tensor<64x64xf16, #shared>>, %arg28: !tt.tensordesc<tensor<64x64xf16, #shared>>) num_warps(4) {
      ...
      %47:5 = scf.for %arg29 = %c0_i32_8 to %arg26 step %c64_i32_7 iter_args(%arg30 = %c0_i32_8, %arg31 = %c0_i32_8, %arg32 = %c0_i32_8, %arg33 = %c0_i32_8, %arg34 = %c0_i32_8) -> (i32, i32, i32, i32, i32)  : i32 {
        ...
        // MMA QK
        %48 = ttg.memdesc_subview %arg6[%arg30] : !ttg.memdesc<3xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        %49 = ttg.memdesc_subview %arg7[%arg30] : !ttg.memdesc<3xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        %50 = ttg.memdesc_subview %arg8[%arg30, %c0_i32_8, %c0_i32_8] : !ttg.memdesc<3x64x64xf16, #shared, #smem, mutable> -> !ttg.memdesc<64x64xf16, #shared, #smem, mutable, 3x64x64>
        %51 = ttg.memdesc_trans %50 {loop.cluster = 2 : i32, loop.stage = 2 : i32, order = array<i32: 1, 0>} : !ttg.memdesc<64x64xf16, #shared, #smem, mutable, 3x64x64> -> !ttg.memdesc<64x64xf16, #shared2, #smem, mutable, 3x64x64>
        ttng.wait_barrier %49, %arg31 {loop.cluster = 2 : i32, loop.stage = 2 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        %52 = ttg.memdesc_subview %arg9[%arg32, %c0_i32_8, %c0_i32_8] : !ttg.memdesc<2x256x64xf32, #tmem, #ttng.tensor_memory, mutable> -> !ttg.memdesc<256x64xf32, #tmem, #ttng.tensor_memory, mutable, 2x256x64>
        %53 = ttg.memdesc_subview %arg10[%arg32] : !ttg.memdesc<2xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2>
        ttng.wait_barrier %53, %arg33, %true_9 {loop.cluster = 2 : i32, loop.stage = 2 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2>
        %54 = ttg.memdesc_subview %arg11[%arg32] : !ttg.memdesc<2xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2>
        %55 = ttng.tc_gen5_mma %arg12, %51, %52[], %false, %true_9, %48[%true_9], %54[%true_9] {loop.cluster = 2 : i32, loop.stage = 2 : i32, tt.self_latency = 1 : i32} : !ttg.memdesc<256x64xf16, #shared, #smem>, !ttg.memdesc<64x64xf16, #shared2, #smem, mutable, 3x64x64>, !ttg.memdesc<256x64xf32, #tmem, #ttng.tensor_memory, mutable, 2x256x64>, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2>

        %56 = arith.addi %arg32, %c1_i32_10 : i32
        %57 = arith.xori %arg33, %c1_i32_10 : i32
        %58 = arith.cmpi eq, %56, %c2_i32_11 : i32
        %59 = arith.select %58, %c0_i32_8, %56 : i32
        %60 = arith.select %58, %57, %arg33 : i32
        %61 = arith.xori %arg34, %c1_i32_10 : i32

        // MMA PV
        %62 = ttg.memdesc_subview %arg17[%arg30] : !ttg.memdesc<3xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        %63 = ttg.memdesc_subview %arg18[%arg30] : !ttg.memdesc<3xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        %64 = ttg.memdesc_subview %arg19[%arg30, %c0_i32_8, %c0_i32_8] : !ttg.memdesc<3x64x64xf16, #shared, #smem, mutable> -> !ttg.memdesc<64x64xf16, #shared, #smem, mutable, 3x64x64>
        ttng.wait_barrier %63, %arg31 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        ttng.wait_barrier %arg20, %61, %true_9 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
        ttng.wait_barrier %arg21, %arg34 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
        %65 = ttng.tc_gen5_mma %arg22, %64, %arg23[], %true_9, %true_9, %62[%true_9], %arg24[%true_9], %arg25[%true_9] {loop.cluster = 0 : i32, loop.stage = 4 : i32, tt.self_latency = 1 : i32} : !ttg.memdesc<256x64xf16, #tmem1, #ttng.tensor_memory, mutable>, !ttg.memdesc<64x64xf16, #shared, #smem, mutable, 3x64x64>, !ttg.memdesc<256x64xf32, #tmem, #ttng.tensor_memory, mutable, 1x256x64>, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>, !ttg.memdesc<1xi64, #shared1, #smem, mutable>, !ttg.memdesc<1xi64, #shared1, #smem, mutable>

        %66 = arith.addi %arg30, %c1_i32_10 : i32
        %67 = arith.xori %arg31, %c1_i32_10 : i32
        %68 = arith.cmpi eq, %66, %c3_i32_12 : i32
        %69 = arith.select %68, %c0_i32_8, %66 : i32
        %70 = arith.select %68, %67, %arg31 : i32
    ...
    partition1(%arg6: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg7: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg8: !ttg.memdesc<3x64x64xf16, #shared, #smem, mutable>, %arg9: !ttg.memdesc<2x256x64xf32, #tmem, #ttng.tensor_memory, mutable>, %arg10: !ttg.memdesc<2xi64, #shared1, #smem, mutable>, %arg11: !ttg.memdesc<2xi64, #shared1, #smem, mutable>, %arg12: !ttg.memdesc<256x64xf16, #shared, #smem>, %arg13: !ttg.memdesc<3x256xf32, #shared1, #smem, mutable>, %arg14: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg15: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg16: !tt.ptr<f32>, %arg17: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg18: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg19: !ttg.memdesc<3x64x64xf16, #shared, #smem, mutable>, %arg20: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %arg21: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %arg22: !ttg.memdesc<256x64xf16, #tmem1, #ttng.tensor_memory, mutable>, %arg23: !ttg.memdesc<256x64xf32, #tmem, #ttng.tensor_memory, mutable, 1x256x64>, %arg24: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %arg25: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %arg26: i32, %arg27: !tt.tensordesc<tensor<64x64xf16, #shared>>, %arg28: !tt.tensordesc<tensor<64x64xf16, #shared>>) num_warps(4) {
      ...
      %47:2 = scf.for %arg29 = %c0_i32_8 to %arg26 step %c64_i32_7 iter_args(%arg30 = %c0_i32_8, %arg31 = %c0_i32_8) -> (i32, i32)  : i32 {
        // LOAD K
        %48 = ttg.memdesc_subview %arg6[%arg30] : !ttg.memdesc<3xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        ttng.wait_barrier %48, %arg31 {loop.cluster = 4 : i32, loop.stage = 0 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        %49 = ttg.memdesc_subview %arg7[%arg30] : !ttg.memdesc<3xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        ttng.barrier_expect %49, 8192 {loop.cluster = 4 : i32, loop.stage = 0 : i32}, %true_9 : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        %50 = ttg.memdesc_subview %arg8[%arg30, %c0_i32_8, %c0_i32_8] : !ttg.memdesc<3x64x64xf16, #shared, #smem, mutable> -> !ttg.memdesc<64x64xf16, #shared, #smem, mutable, 3x64x64>
        ttng.async_tma_copy_global_to_local %arg27[%arg29, %c0_i32_8] %50, %49, %true_9 {loop.cluster = 4 : i32, loop.stage = 0 : i32} : !tt.tensordesc<tensor<64x64xf16, #shared>>, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> -> !ttg.memdesc<64x64xf16, #shared, #smem, mutable, 3x64x64>

        // LOAD V
        %51 = ttg.memdesc_subview %arg17[%arg30] : !ttg.memdesc<3xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        ttng.wait_barrier %51, %arg31 {loop.cluster = 2 : i32, loop.stage = 2 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        %52 = ttg.memdesc_subview %arg18[%arg30] : !ttg.memdesc<3xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        ttng.barrier_expect %52, 8192 {loop.cluster = 2 : i32, loop.stage = 2 : i32}, %true_9 : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        %53 = ttg.memdesc_subview %arg19[%arg30, %c0_i32_8, %c0_i32_8] : !ttg.memdesc<3x64x64xf16, #shared, #smem, mutable> -> !ttg.memdesc<64x64xf16, #shared, #smem, mutable, 3x64x64>
        ttng.async_tma_copy_global_to_local %arg28[%arg29, %c0_i32_8] %53, %52, %true_9 {loop.cluster = 2 : i32, loop.stage = 2 : i32} : !tt.tensordesc<tensor<64x64xf16, #shared>>, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> -> !ttg.memdesc<64x64xf16, #shared, #smem, mutable, 3x64x64>

        %54 = arith.addi %arg30, %c1_i32_10 : i32
        %55 = arith.xori %arg31, %c1_i32_10 : i32
        %56 = arith.cmpi eq, %54, %c3_i32_11 : i32
        %57 = arith.select %56, %c0_i32_8, %54 : i32
        %58 = arith.select %56, %55, %arg31 : i32
    ...
    partition2(%arg6: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg7: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg8: !ttg.memdesc<3x64x64xf16, #shared, #smem, mutable>, %arg9: !ttg.memdesc<2x256x64xf32, #tmem, #ttng.tensor_memory, mutable>, %arg10: !ttg.memdesc<2xi64, #shared1, #smem, mutable>, %arg11: !ttg.memdesc<2xi64, #shared1, #smem, mutable>, %arg12: !ttg.memdesc<256x64xf16, #shared, #smem>, %arg13: !ttg.memdesc<3x256xf32, #shared1, #smem, mutable>, %arg14: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg15: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg16: !tt.ptr<f32>, %arg17: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg18: !ttg.memdesc<3xi64, #shared1, #smem, mutable>, %arg19: !ttg.memdesc<3x64x64xf16, #shared, #smem, mutable>, %arg20: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %arg21: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %arg22: !ttg.memdesc<256x64xf16, #tmem1, #ttng.tensor_memory, mutable>, %arg23: !ttg.memdesc<256x64xf32, #tmem, #ttng.tensor_memory, mutable, 1x256x64>, %arg24: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %arg25: !ttg.memdesc<1xi64, #shared1, #smem, mutable>, %arg26: i32, %arg27: !tt.tensordesc<tensor<64x64xf16, #shared>>, %arg28: !tt.tensordesc<tensor<64x64xf16, #shared>>) num_warps(4) {
      ...
      %47:5 = scf.for %arg29 = %c0_i32_8 to %arg26 step %c64_i32_7 iter_args(%arg30 = %c0_i32_8, %arg31 = %c0_i32_8, %arg32 = %c0_i32_8, %arg33 = %c-1_i32, %arg34 = %c0_i32_8) -> (i32, i32, i32, i32, i32)  : i32 {
        ...
        %56 = tt.addptr %arg16, %arg29 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !tt.ptr<f32>, i32
        %57 = tt.load %56 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !tt.ptr<f32>
        %58 = tt.splat %57 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : f32 -> tensor<256x64xf32, #blocked>
        ttng.wait_barrier %54, %51 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        %59 = ttg.local_load %53 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<256xf32, #shared1, #smem, mutable, 3x256> -> tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>>
        ttng.arrive_barrier %55, 1 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        ...
        ttng.wait_barrier %66, %63 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        %68 = ttg.local_load %65 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<256xf32, #shared1, #smem, mutable, 3x256> -> tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>>
        ttng.arrive_barrier %67, 1 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3>
        %69 = arith.subf %68, %59 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>>
        %70 = math.exp2 %69 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>>
        %71 = tt.expand_dims %70 {axis = 1 : i32, loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256xf32, #ttg.slice<{dim = 1, parent = #blocked}>> -> tensor<256x1xf32, #blocked>
        %72 = tt.broadcast %71 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256x1xf32, #blocked> -> tensor<256x64xf32, #blocked>
        ttng.wait_barrier %arg24, %arg30 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
        %result_12, %token_13 = ttng.tmem_load %arg23[] {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<256x64xf32, #tmem, #ttng.tensor_memory, mutable, 1x256x64> -> tensor<256x64xf32, #blocked>
        %73 = arith.xori %arg30, %c1_i32_10 : i32
        %74 = arith.mulf %result_12, %72 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256x64xf32, #blocked>
        %75 = arith.addf %74, %58 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256x64xf32, #blocked>
        %76 = ttng.tmem_store %75, %arg23[], %true_9 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : tensor<256x64xf32, #blocked> -> !ttg.memdesc<256x64xf32, #tmem, #ttng.tensor_memory, mutable, 1x256x64>
        ttng.arrive_barrier %arg20, 1 {loop.cluster = 0 : i32, loop.stage = 4 : i32} : !ttg.memdesc<1xi64, #shared1, #smem, mutable>
